      ...
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            ...
            <li><a href="login?accion=admin">Administración</a></li>                        
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <table class="table table-striped">
            ...
            <tbody>   
                <c:forEach items="${listVacante}" var="vac" >
                <tr>
                  <td class="left">${vac.id}</td>
                  <td>${vac.nombre}</td>
                  <td>${vac.fechaPublicacion}</td>
                  <td>
                    <a class="btn btn-default" href="vacante?accion=ver&id=${vac.id}" role="button">Ver Detalles</a>  
                    <c:if test="${usuario.id > 0}">
                    <a class="btn btn-default" href="vacante?accion=delete&id=${vac.id}" role="button">Eliminar</a>                         
                    </c:if>
                  </td>  
                </tr>
                </c:forEach>
