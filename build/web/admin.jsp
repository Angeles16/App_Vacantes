    ...
    <div class="container">
      ...
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            <li><a href="login?accion=addvacante">Crear Vacante</a></li>            
            <li><a href="vacante?accion=getall">Vacantes</a></li>                           
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          ...
          <h2 class="panel-title"><b>Estatus</b><br>${usuario.estado}<br><br></h2>
        </div>
      </div>
